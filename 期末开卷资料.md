...
![image-20231224213549136](./图图/image-20231224213549136.png)
...
![image-20231224214305560](./图图/image-20231224214305560.png)

只要，$c$和$n_0$足够大，就可以隐藏掉$\Theta(n)$。数学归纳法要求除了归纳情况满足之外，基本情况也要满足，即当$n_0 \leq n \leq 2n_0$时有$T(n) \leq cnlgn$

![image-20231224214533652](./图图/image-20231224214533652.png)
...
![image-20231224215140866](./图图/image-20231224215140866.png)

![image-20231224215206990](./图图/image-20231224215206990.png)
...
![image-20231224215626706](./图图/image-20231224215626706.png)

情况1的实例：

![image-20231224215823619](./图图/image-20231224215823619.png)

情况2的实例：

![image-20231224220032182](./图图/image-20231224220032182.png)
...
![image-20231224220523621](./图图/image-20231224220523621.png)

![image-20231224220653559](./图图/image-20231224220653559.png)

2. Use the master method to give tight asymptotic bounds for the following recurrences

![image-20231224221027044](./图图/image-20231224221027044.png)
...
![image-20231225112118620](./图图/image-20231225112118620.png)
...
![image-20231225112505607](./图图/image-20231225112505607.png)

* 自顶向下递归实现

![image-20231225112643470](./图图/image-20231225112643470.png)

分析CUT-ROD的运行时间：$T(0)=1$，$T(n)=1+ \sum^{n-1}_{j=0}T(j)$，解得$T(n)=2^n$

* 使用动态规划

![image-20231225112857878](./图图/image-20231225112857878.png)

动态规划有两种实现方法

![image-20231225113033189](./图图/image-20231225113033189.png)

**记忆化的自顶向下**：

![image-20231225113426184](./图图/image-20231225113426184.png)

**自底向上**：

![image-20231225113558338](./图图/image-20231225113558338.png)

为了重构最优解，可以对上述函数进行改造：

![image-20231225113824023](./图图/image-20231225113824023.png)

### 4.2 最长公共子序列（LCS）

![image-20231225114008041](./图图/image-20231225114008041.png)

**LCS的最优子结构**：

![image-20231225114109538](./图图/image-20231225114109538.png)

**LCS的一个递归解**：

![image-20231225114206419](./图图/image-20231225114206419.png)

**计算LCS的长度**：

LCS问题有$\Theta(mn)$个不同的子问题，可以采用自底向上动态规划进行计算。

![image-20231225114404171](./图图/image-20231225114404171.png)

![image-20231225114424776](./图图/image-20231225114424776.png)

计算每个表项的运行时间为$\Theta(1)$，所以LCS-LENGTH的运行时间为$\Theta(mn)$

**构造一个LCS**：

![image-20231225114710138](./图图/image-20231225114710138.png)
...
![image-20231225115222104](./图图/image-20231225115222104.png)

给定一个概率集合，我们希望构造一棵搜索代价最小的二叉搜索树

**Step1**：最优二叉搜索树的结构

![image-20231225115346196](./图图/image-20231225115346196.png)

**Step2**：一个递归解

![image-20231225115645242](./图图/image-20231225115645242.png)

![image-20231225115827973](./图图/image-20231225115827973.png)

为了帮助构造最优解，定义$root[i,j]$保存关键字$k_i,\dots,k_{r-1}$的最优二叉树的根节点关键字$k_r$的下表$r$

**Step3**：计算最优二叉搜索树的期望搜索代价

![image-20231225115957016](./图图/image-20231225115957016.png)

![image-20231225120203805](./图图/image-20231225120203805.png)
...
![image-20231225120431998](./图图/image-20231225120431998.png)
...
![image-20231225120605995](./图图/image-20231225120605995.png)
...
![image-20231225120700437](./图图/image-20231225120700437.png)

![image-20231225120817299](./图图/image-20231225120817299.png)

![image-20231225120832237](./图图/image-20231225120832237.png)
...
![image-20231225121703007](./图图/image-20231225121703007.png)

**活动选择问题的最优子结构**：

![image-20231225121947045](./图图/image-20231225121947045.png)

**做出贪心选择**：

![image-20231225122052246](./图图/image-20231225122052246.png)
...
![image-20231225122450417](./图图/image-20231225122450417.png)

**迭代贪心算法**：

![image-20231225122622919](./图图/image-20231225122622919.png)

### 5.2 贪心策略基本原理

![image-20231225122952250](./图图/image-20231225122952250.png)

![image-20231225123118444](./图图/image-20231225123118444.png)

![image-20231225123146844](./图图/image-20231225123146844.png)

**贪心VS动态规划**：

![image-20231225123301631](./图图/image-20231225123301631.png)

### 5.3 离线缓存（Offline caching）

![image-20231225123531809](./图图/image-20231225123531809.png)

情况2和情况3称为缓存未命中，情况2称为强制未命中

![image-20231225123702029](./图图/image-20231225123702029.png)

**离线缓存的最优子结构**：

![image-20231225123847529](./图图/image-20231225123847529.png)

**离线缓存的贪心选择性质**：

![image-20231225132144533](./图图/image-20231225132144533.png)
...
![image-20231225132545892](./图图/image-20231225132545892.png)
...
![image-20231225132648569](./图图/image-20231225132648569.png)

## 六. 最小生成树（Minimum Spanning Trees）

![image-20231225212551611](./图图/image-20231225212551611.png)

### 6.1 生成一颗最小生成树

![image-20231225212707280](./图图/image-20231225212707280.png)

**切割**：

![image-20231225212925151](./图图/image-20231225212925151.png)

**重要定理**：

![image-20231225213033734](./图图/image-20231225213033734.png)

### 6.2 Kruskal算法

$A$是一个森林，该森林的顶点为$V$，每次加入到$A$中的安全边永远是权重最小的连接两个不同分量的边

![image-20231225213314966](./图图/image-20231225213314966.png)

### 6.3 Prim算法

$A$是一棵树，每次加入到$A$的安全边永远连接$A$和$V-A$的边中权重最小的边

![image-20231225213516894](./图图/image-20231225213516894.png)

### 6.4 一些概念

* 最小优先队列

![image-20231225213700474](./图图/image-20231225213700474.png)

![image-20231225213732551](./图图/image-20231225213732551.png)

![image-20231225213744150](./图图/image-20231225213744150.png)
...
![image-20231225214051794](./图图/image-20231225214051794.png)

## 七. 最短路径（Shortest Paths）

![image-20231225214345931](./图图/image-20231225214345931.png)

### 7.1 基本概念

![image-20231225214326212](./图图/image-20231225214326212.png)

**最短路径的最优子结构**：

![image-20231225214503662](./图图/image-20231225214503662.png)

**负权重边**：

![image-20231225214544351](./图图/image-20231225214544351.png)

**环路**：

![image-20231225214640545](./图图/image-20231225214640545.png)
...
![image-20231225215010573](./图图/image-20231225215010573.png)

![image-20231225215151459](./图图/image-20231225215151459.png)

### 7.2 单源最短路径

**Dijkstra算法**：能够解决有向带权图$G=(V,E)$上的单源最短路径问题，但要求所有边$(u,v)\in E$的权重$w(u,v) \geq0$

![image-20231225215700402](./图图/image-20231225215700402.png)

**时间复杂度**：

![image-20231225215907840](./图图/image-20231225215907840.png)

### 7.3 全源最短路径

![image-20231225220030859](./图图/image-20231225220030859.png)

**Floyd-Warshall算法**：输入图中可以存在权重为负的边，但不能存在权重为负的环路。这个算法是基于可用中间顶点的最大个数进行动态规划

![image-20231225220358747](./图图/image-20231225220358747.png)

![image-20231225220424296](./图图/image-20231225220424296.png)

![image-20231225220612090](./图图/image-20231225220612090.png)

**自底向上计算最短路径权重**：

![image-20231225220708292](./图图/image-20231225220708292.png)

![image-20231225220727267](./图图/image-20231225220727267.png)

**构造一条最短路径**：

![image-20231225220848329](./图图/image-20231225220848329.png)
...
![image-20231225221005755](./图图/image-20231225221005755.png)
...
![image-20231226094324096](./图图/image-20231226094324096.png)
...
![image-20231226095638407](./图图/image-20231226095638407.png)
...
![image-20231226100049068](./图图/image-20231226100049068.png)

![image-20231226100408539](./图图/image-20231226100408539.png)

* P问题的再定义：

![image-20231226100612348](./图图/image-20231226100612348.png)

解决一个问题的复杂度很大程度上取决于它的编码方式：

![image-20231226100512498](./图图/image-20231226100512498.png)
...
![image-20231226101545797](./图图/image-20231226101545797.png)
...
![image-20231226102336163](./图图/image-20231226102336163.png)
...
* 语言的规约（**Reducibility**）
  ...
  ![image-20231226103353030](./图图/image-20231226103353030.png)

* 重要引理：

![image-20231226103446855](./图图/image-20231226103446855.png)
...
![image-20231226103702754](./图图/image-20231226103702754.png)
...
![image-20231226104041668](./图图/image-20231226104041668.png)

* $CIRCUIT-SAT \leq_P SAT$

  ![image-20231226104236978](./图图/image-20231226104236978.png)

​		![image-20231226104301712](./图图/image-20231226104301712.png)

* $SAT \leq_P 3-CNF-SAT$（三合取范式）

![image-20231226104426422](./图图/image-20231226104426422.png)

![image-20231226104437347](./图图/image-20231226104437347.png)

![image-20231226104533458](./图图/image-20231226104533458.png)

![image-20231226104454670](./图图/image-20231226104454670.png)

![image-20231226104700933](./图图/image-20231226104700933.png)

* 更多NPC问题

![image-20231226104727847](./图图/image-20231226104727847.png)
...
![image-20231226110329731](./图图/image-20231226110329731.png)

* Step of a process and layering

![image-20231226110514934](./图图/image-20231226110514934.png)
...
![image-20231226111339684](./图图/image-20231226111339684.png)

* **Stubborn links**

![image-20231226111405150](./图图/image-20231226111405150.png)
...
![image-20231226111529344](./图图/image-20231226111529344.png)
...
![image-20231226111756935](./图图/image-20231226111756935.png)
...
![image-20231226112055758](./图图/image-20231226112055758.png)

![image-20231226112126620](./图图/image-20231226112126620.png)
...
![image-20231226112211593](./图图/image-20231226112211593.png)

![image-20231226112234058](./图图/image-20231226112234058.png)
...
![image-20231226112342759](./图图/image-20231226112342759.png)

**Leader Election**：

![image-20231226112522174](./图图/image-20231226112522174.png)
...
![image-20231226112553733](./图图/image-20231226112553733.png)

![image-20231226112623055](./图图/image-20231226112623055.png)
...
![image-20231226112657834](./图图/image-20231226112657834.png)

### 9.6 作业

1. What happens if the assumption for Δ does not hold? Which property is violated? Give an example

![image-20231226112745370](./图图/image-20231226112745370.png)

![image-20231226112757440](./图图/image-20231226112757440.png)
...
![image-20231226113003578](./图图/image-20231226113003578.png)
...
![image-20231226145204552](./图图/image-20231226145204552.png)

**实现**：

![image-20231226145747620](./图图/image-20231226145747620.png)

评：no creation和no duplication都是直接依赖于perfect links实现的；一次通信会产生$O(N)$条信息

* **(Regular) Reliable Broadcast**

![image-20231226145526172](./图图/image-20231226145526172.png)

**实现（Lazy）**：

![image-20231226145812548](./图图/image-20231226145812548.png)

评：最好情况下是一次通信和产生$O(N)$条消息；最坏情况下是$O(N)$次通信和$O(N^2)$条消息

**实现（Eager）：**

![image-20231226150152721](./图图/image-20231226150152721.png)

评：最好情况下是一次通信和产生$O(N^2)$条消息；最坏情况下是$O(N)$次通信和$O(N^2)$条消息

* **Uniform reliable broadcast**

![image-20231226150300012](./图图/image-20231226150300012.png)

**实现（All-Ack Uniform Reliable Broadcast）**：

![image-20231226150414557](./图图/image-20231226150414557.png)

![image-20231226150424085](./图图/image-20231226150424085.png)

![image-20231226150510111](./图图/image-20231226150510111.png)

评：最好情况下是两次通信和产生$O(N^2)$条消息；最坏情况下是$O(N)$次通信和$O(N^2)$条消息

### 10.2 Quorum

![image-20231226150703995](./图图/image-20231226150703995.png)
...
![image-20231226151153186](./图图/image-20231226151153186.png)

![image-20231226151208248](./图图/image-20231226151208248.png)

正确性解释：

![image-20231226151320850](./图图/image-20231226151320850.png)

![image-20231226151332261](./图图/image-20231226151332261.png)
...
![image-20231226151619545](./图图/image-20231226151619545.png)

但logic clocks仍然存在问题：Logical clocks cannot convey causal relation

![image-20231226151800039](./图图/image-20231226151800039.png)

于是使用Vector clocks

![image-20231226151845430](./图图/image-20231226151845430.png)

![image-20231226152022030](./图图/image-20231226152022030.png)

![image-20231226152152906](./图图/image-20231226152152906.png)

![image-20231226152227482](./图图/image-20231226152227482.png)

**实现（No-Waiting Causal-Order Broadcast）：**

![image-20231226152307240](./图图/image-20231226152307240.png)

为了解决pass[]规模过大占用空间的问题，要采取截断的方法

![image-20231226152543009](./图图/image-20231226152543009.png)

也可以完全去掉pass[]，即实现**Waiting Causal Broadcast**

![image-20231226152635524](./图图/image-20231226152635524.png)
...
![image-20231226152820927](./图图/image-20231226152820927.png)
...
![image-20231226152941675](./图图/image-20231226152941675.png)
...
![image-20231226153219508](./图图/image-20231226153219508.png)

### 11.2 Uniform consensus

![image-20231226153500391](./图图/image-20231226153500391.png)

### 11.3 Consensus算法1

![image-20231226153647343](./图图/image-20231226153647343.png)

![image-20231226153714494](./图图/image-20231226153714494.png)

![image-20231226153731636](./图图/image-20231226153731636.png)

### 11.4 Consensus算法2

![image-20231226153907877](./图图/image-20231226153907877.png)

![image-20231226153926125](./图图/image-20231226153926125.png)

![image-20231226153936381](./图图/image-20231226153936381.png)

### 11.5 Total Order Broadcast

![image-20231226154135547](./图图/image-20231226154135547.png)

而Total Order要求所有进程发送信息的顺序是一致的，但不要求因果性

![image-20231226154242765](./图图/image-20231226154242765.png)

![image-20231226154258075](./图图/image-20231226154258075.png)

![image-20231226154309282](./图图/image-20231226154309282.png)

### 11.6 Consensus算法3

![image-20231226154406438](./图图/image-20231226154406438.png)

![image-20231226154611078](./图图/image-20231226154611078.png)

![image-20231226154820471](./图图/image-20231226154820471.png)

![image-20231226154832137](./图图/image-20231226154832137.png)

![image-20231226154846230](./图图/image-20231226154846230.png)

![image-20231226154857349](./图图/image-20231226154857349.png)

正确性说明：

![image-20231226155002255](./图图/image-20231226155002255.png)

**Correctness argument: Termination**：

![image-20231226155011702](./图图/image-20231226155011702.png)

**Correctness argument: Agreement**：

![image-20231226155042715](./图图/image-20231226155042715.png)

### 11.7 作业

1. Implement Consensus using total-order broadcast

![image-20231226155138894](./图图/image-20231226155138894.png)

2. Explain why any consensus algorithm that uses Eventually Perfect Faliure Detector actually solves uniform consensus

![image-20231226155226115](./图图/image-20231226155226115.png)
...
![image-20231229161056508](./图图/image-20231229161056508.png)

Terminating reliable broadcast中的正常进程会在收不到消息时模拟收到了一个默认值

![image-20231229161207854](./图图/image-20231229161207854.png)

![image-20231229161324559](./图图/image-20231229161324559.png)

![image-20231229161415785](./图图/image-20231229161415785.png)

![image-20231229161443586](./图图/image-20231229161443586.png)

**实现**：

![image-20231229161515611](./图图/image-20231229161515611.png)

![image-20231229161555379](./图图/image-20231229161555379.png)

![image-20231229161609260](./图图/image-20231229161609260.png)
...
![image-20231229161731518](./图图/image-20231229161731518.png)

* Uniform Agreement：By Consensus Uniform Agreement
* Termination：

![image-20231229161816744](./图图/image-20231229161816744.png)

### 12.2 Group membership

用来提供关于当前那些进程正处于工作状态的信息，与错误检测器是有区别的，错误检测器可能会导致各个进程收到的信息不一致

![image-20231229162106116](./图图/image-20231229162106116.png)

![image-20231229162134652](./图图/image-20231229162134652.png)

![image-20231229162148254](./图图/image-20231229162148254.png)

**实现**：

![image-20231229162212075](./图图/image-20231229162212075.png)

**正确性**：

![image-20231229162316880](./图图/image-20231229162316880.png)

![image-20231229162330780](./图图/image-20231229162330780.png)
...
![image-20231229162856925](./图图/image-20231229162856925.png)

![image-20231229162908929](./图图/image-20231229162908929.png)

![image-20231229163001297](./图图/image-20231229163001297.png)

![image-20231229163033555](./图图/image-20231229163033555.png)

![image-20231229163044419](./图图/image-20231229163044419.png)

**实现**：

![image-20231229163100908](./图图/image-20231229163100908.png)

**正确性**：

![image-20231229163156707](./图图/image-20231229163156707.png)

![image-20231229163205517](./图图/image-20231229163205517.png)

### 12.4 作业

1. Try to implement P assuming utrb (and perfect links）

![image-20231229163252330](./图图/image-20231229163252330.png)

2. Can you implement P using gm

![image-20231229163314275](./图图/image-20231229163314275.png)

## 十三. Miscellaneous（杂项）

![image-20231229163503525](./图图/image-20231229163503525.png)

![image-20231229163518842](./图图/image-20231229163518842.png)

![image-20231229163534132](./图图/image-20231229163534132.png)

![image-20231229163548707](./图图/image-20231229163548707.png)

![image-20231229163605805](./图图/image-20231229163605805.png)

![image-20231229163618043](./图图/image-20231229163618043.png)

![image-20231229163637323](./图图/image-20231229163637323.png)

![image-20231229163650195](./图图/image-20231229163650195.png)

![image-20231229163701107](./图图/image-20231229163701107.png)

![image-20231229163716084](./图图/image-20231229163716084.png)
